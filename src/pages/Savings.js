  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Progresso Geral</h2>
      ...
      {/* Dicas de economia */}
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Dicas para Economizar</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {savingsTips.map((tip) => (
            <div key={tip.id} className="border border-gray-200 rounded-lg p-4">
              <h3 className="text-md font-medium text-gray-900 mb-2">{tip.title}</h3>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Calculadora de Economia</h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="text-md font-medium text-gray-900 mb-2">R$ 5 por dia</h3>
            <p className="text-sm text-gray-700">R$ 150 por mês</p>
            <p className="text-sm text-gray-700">R$ 1.825 por ano</p>
          </div>
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="text-md font-medium text-gray-900 mb-2">R$ 10 por dia</h3>
            <p className="text-sm text-gray-700">R$ 300 por mês</p>
            <p className="text-sm text-gray-700">R$ 3.650 por ano</p>
          </div>
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="text-md font-medium text-gray-900 mb-2">R$ 20 por dia</h3>
            <p className="text-sm text-gray-700">R$ 600 por mês</p>
            <p className="text-sm text-gray-700">R$ 7.300 por ano</p>
          </div>
        </div>
      </div>
    </div>
